...
public interface TargetBasedArtifactRelationshipDescriptor extends ArtifactRelationshipDescriptor {
	...
	/**
	 * Evaluates if the given {@link Artifact} is the target of the described
	 * {@link ArtifactRelationship}.
	 *
	 * @param targetCandidateArtifact The {@link Artifact} to be evaluated
	 * @return true, if the given {@link Artifact} is the target of the described
	 ...
	 * {@link #isTarget(Artifact)}, this method is called by passing
